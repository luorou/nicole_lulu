...
class MainRenderer extends BaseChartRenderer<CandleEntity> {
  ...
  MainRenderer(
      Rect mainRect, double maxValue, double minValue, double topPadding, this.state, this.isLine, int fixedLength,
      ...
      span = TextSpan(
        children: [
          data.up != 0
              ...
              : Container(),
          data.mb != 0
              ? TextSpan(text: "UB:${format(data.up)}    ", style: getTextStyle(ChartColors.ma10Color))
              : Container(),
          data.dn != 0
