...
import 'package:nicolelulu/widget/k_line/utils/number_util.dart';
...
class ChartPainter extends BaseChartPainter {
  ...
  void initChartRenderer() {
    ...
    if (mSecondaryRect != null)
      mSecondaryRenderer ??= SecondaryRenderer(mSecondaryRect, mSecondaryMaxValue, mSecondaryMinValue, mChildPadding, secondaryState, fixedLength);
  }
